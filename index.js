...
/*
  - The function nestedFunction doesn't have internal in its local scope, so it looks outside its lexical scope for it.
  - "internal" is declared in the same scope as nestedFunction, so its accessible through that.
*/
...
// console.log('summation(0)', summation(0));
// console.log('summation(5)', summation(5));
// console.log('summation(69)', summation(69));
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(animals) {
    const displayNames = animals.map( animal => `name: ${animal.animal_name}, scientific: ${animal.scientific_name}` );
    return displayNames;
  }
  ...
  */
  ...
  function USApop(animals){
    ...
    return animals.reduce(reducer, 0);
  }
...
// 🦄 💪 Stretch Task: Extend the base class CuboidMaker with a sub class called CubeMaker.  Find out the formulas for volume and surface area for cubes and create those methods using the dimension properties from CuboidMaker.  Test your work by logging out your volume and surface area. 🦄 💪
  ...
  // const twentyCube = new CubeMaker(20);
  // console.log(twentyCube.volume());
  // console.log(twentyCube.surfaceArea());
